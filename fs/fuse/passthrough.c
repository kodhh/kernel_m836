...
extern ssize_t vfs_iter_read(struct file *file, struct iov_iter *iter, loff_t *ppos);
extern ssize_t vfs_iter_write(struct file *file, struct iov_iter *iter, loff_t *ppos);
